...
def test_upsert_stores_supplier_id_in_payload(
    repository: QdrantSupplierRepository, client: MagicMock
) -> None:
...
def test_get_vector_returns_embedding_when_found(
    repository: QdrantSupplierRepository, client: MagicMock
) -> None:
...
def test_get_vector_returns_none_when_not_found(
    repository: QdrantSupplierRepository, client: MagicMock
) -> None:
