...
class SmartQuestionServiceImpl(ISmartQuestionService):
    ...
    async def get_or_generate_questions(
        ...
        existing_questions = await self.question_repository.get_active_by_provider(
            provider_id
        )
        ...
        if (
            clean_category == "construccion"
            or clean_category == "obras_civiles"
            or clean_category == "constructora"
        ):
            ...
            questions_pool = [
                ...
                },
                {
                    ...
                    "options": [
                        "No",
                        "Sí, en el registro de Vivienda",
                        "Sí, en el registro de Urbanización",
                        "Ambos",
                    ],
                },
                {
                ...
                },
                {
                    ...
                    "options": [
                        "No",
                        "Sí, Técnico en Prevención",
                        "Sí, Ingeniero Prevencionista",
                    ],
                },
                {
                    ...
                    "options": [
                        "No posee (Subcontrata)",
                        "Cuenta con flota menor propia (Retro/Minicargadores)",
                        "Cuenta con flota mayor propia (Excavadoras/Camiones Tolva)",
                    ],
                },
                {
                    ...
                    "options": [
                        "Ninguna",
                        "ISO 9001 (Calidad)",
                        "ISO 14001 o 45001 (Ambiente/Seguridad)",
                ...
                },
                {
                    ...
                    "options": [
                        "No, solo edificación tradicional",
                        "Sí, de 1 a 3 proyectos",
                        "Sí, más de 3 proyectos especializados",
                    ],
                },
                {
                    ...
                    "options": [
                        "Mediante laboratorios externos certificados",
                        "Contamos con equipamiento propio de control",
                        "No aplica a nuestras obras",
                    ],
                },
                {
                    ...
                    "options": [
                        "Solo comuna base",
                        "Regional completo",
                        "Interregional (Centro/Norte/Sur)",
                        "Nacional",
                    ],
                },
                {
                    ...
                    "options": [
                        "No, trabajamos en CAD tradicional",
                        "Sí, nivel básico/intermedio",
                        "Sí, modelamos proyectos complejos en BIM",
                    ],
                },
            ]
            ...
            questions_pool = [
                ...
                {
                    "question": "Placerholder",
                    "target_field": "Placerholder",
                    "options": ["Sí", "No"],
                },
            ]
        else:
